...
# Type: String
# Valid values:
#   - all: Accept all cookies. - no-3rdparty: Accept cookies from the same origin only. This is known to break some sites, such as GMail.
#   - no-unknown-3rdparty: Accept cookies from the same origin only, unless a cookie is already set for the domain. On QtWebEngine, this is the same as no-3rdparty.
#   - never: Don't accept cookies at all.
...
mode = 'normal'
config.bind('d', 'run-with-count 5 scroll down', mode = 'normal')
config.bind('u', 'run-with-count 5 scroll up', mode = 'normal')
